...
class PredicateViewWidget(
    ...
    width,
    height,
    Text.translatableWithFallback("trueadaptivemusic.predicate_view", "Predicate View").string,
    true,
    false,
    true,
    false,
            ...
            addWidgetFromRender(
                {
                    ...
                    widget.setTooltip(Tooltip.of(Constants.REQUIRES_SERVER_SUPPORT_TOOLTIP))
                    widget
                },
                "serverOnlyWarning"
            )
