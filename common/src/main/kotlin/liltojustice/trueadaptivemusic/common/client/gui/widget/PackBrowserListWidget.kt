...
import liltojustice.trueadaptivemusic.common.client.browser.DataSizeHelper
import liltojustice.trueadaptivemusic.common.client.browser.DownloadButtonWidget
import liltojustice.trueadaptivemusic.common.client.browser.PackManifest
import liltojustice.trueadaptivemusic.common.client.gui.ImageProcessor
import liltojustice.trueadaptivemusic.common.client.gui.RenderState
import liltojustice.trueadaptivemusic.common.client.gui.extensions.drawBorder
import liltojustice.trueadaptivemusic.common.client.gui.extensions.drawMarqueedWrappedText
...
class PackBrowserListWidget(
    ...
    private fun renderPackImage(
        graphics: GuiGraphicsExtractor, panelX: Int, panelWidth: Int, imagePath: Path
    ): Boolean {
