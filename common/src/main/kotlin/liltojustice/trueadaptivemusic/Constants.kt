...
class Constants {
    companion object {
        ...
        val NULL_IDENTIFIER: ResourceLocation = ResourceLocation.fromNamespaceAndPath("trueadaptivemusic", "null")
        val REQUIRES_SERVER_SUPPORT_TRIGGERS = listOf(
            "structure", "structure_set", "spawn_point_nearby", "scoreboard", "custom")
        val REQUIRES_SERVER_SUPPORT_TEXT = "*${
            Component.translatableWithFallback(
            "trueadaptivemusic.requires_server",
            "Host must have TAM installed!"
        ).string}*"
        val REQUIRES_SERVER_SUPPORT_TOOLTIP: MutableComponent = Component.translatableWithFallback(
