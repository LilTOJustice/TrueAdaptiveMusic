...
object Constants {
    const val TRUE_ADAPTIVE_MUSIC = "trueadaptivemusic"
    ...
    val OPTIONS_DIR = Path("config", TRUE_ADAPTIVE_MUSIC)
    ...
    val DISCORD_JOIN_TEXT: MutableComponent = Component.translatableWithFallback(
        "$TRUE_ADAPTIVE_MUSIC.join_discord", "Join the Discord!")
    val NULL_IDENTIFIER = ResourceLocation.fromNamespaceAndPath(TRUE_ADAPTIVE_MUSIC, "null")
    ...
    const val TAM_ICON_RESOURCE_PATH = "assets/$TRUE_ADAPTIVE_MUSIC/icon.png"
