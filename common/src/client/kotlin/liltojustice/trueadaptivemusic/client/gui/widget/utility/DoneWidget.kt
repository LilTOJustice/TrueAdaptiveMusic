...
fun makeDoneButton(textRenderer: Font, screenWidth: Int, screenHeight: Int, action: () -> Unit): Button {
    val doneButton = Button.builder(CommonComponents.GUI_DONE) { action() }.build()
    doneButton.width = textRenderer.width(CommonComponents.GUI_DONE) + 10
