...
class NodeViewWidget(
            ...
            addWidgetFromRender(
                { val eventWidget = ClickableTextWidget(
                    ...
                    onClick = {
                        ...
                        onEventClick(event)
                        scrollToBottom() },
                    isHoveredOrFocused = { selectedEvent == event })
        ...
        addWidgetFromRender(
            {
                val result = ClickableTextWidget(
                    ...
                    onClick = {
                        ...
                        onEventClick(null)
                        scrollToBottom() },
                    isHoveredOrFocused = { selectedEvent == null && inEventView() }
                )
                result.setTooltip(
                    Tooltip.create(
                        Component.translatableWithFallback(
    ...
    companion object {
        val AMBIENCE_CHOICE_TEXT: MutableComponent = Component.translatableWithFallback(
