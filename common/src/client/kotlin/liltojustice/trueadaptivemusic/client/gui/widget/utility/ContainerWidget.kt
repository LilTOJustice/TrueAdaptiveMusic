...
abstract class ContainerWidget(
    ...
    override fun mouseDragged(click: MouseButtonEvent, offsetX: Double, offsetY: Double): Boolean {
        if (verticalScrollHeld) {
            ...
            getVerticalScrollbarExtent()?.let {
                ...
                verticalScrollPosition += (offsetY * ratio) / getRowHeight(textRenderer.lineHeight)
            }
        }
    ...
    protected open fun renderDarkening(context: GuiGraphics) {
        this.renderDarkening(context, this.width, this.height)
    }

    protected open fun renderDarkening(context: GuiGraphics, width: Int, height: Int) {
