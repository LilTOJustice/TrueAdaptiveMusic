...
abstract class ContainerWidget(
    ...
    private fun drawVerticalScrollbar(context: GuiGraphics?): Triple<Int, Int, Int>? {
        ...
        context?.let {
            it.setColor(0f, 0f, 0f, 0.75f)
            it.vLine(x, y + headerOffset, y + adjustedHeight + headerOffset, CommonColors.BLACK)
    ...
    private fun drawHorizontalScrollbar(context: GuiGraphics?): Triple<Int, Int, Int>? {
        ...
        context?.let {
            it.setColor(0f, 0f, 0f, 0.75f)
            it.hLine(x + offset, x + usableWidth, y, CommonColors.BLACK)
            it.setColor(1f, 1f, 1f, 1f)
