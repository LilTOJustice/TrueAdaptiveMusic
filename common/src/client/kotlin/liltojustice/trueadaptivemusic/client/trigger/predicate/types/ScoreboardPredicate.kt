...
object ScoreboardPredicate: StaticPredicateType<ScoreboardPredicate.Arguments>(
    ...
    override fun test(arguments: Arguments): Boolean {
        ...
        val matchingEntry = scoreboard.getOrCreatePlayerScore(playerName, matchingObjective)
        return compare(arguments.comparison, matchingEntry.score, arguments.value)
    }
