...
object SpawnPointNearbyPredicate: StaticPredicateType<SpawnPointNearbyPredicate.Arguments>(
    ...
    override fun test(arguments: Arguments): Boolean {
        ...
        return spawnPoint.dimension.location() == player.level().dimensionTypeRegistration().unwrapKey()
            .get().location() &&
                spawnPoint.blockPos.distSqr(player.blockPosition()) <= blockRadiusSquared
    }
}