...
object PlayerAttributePredicate: StaticPredicateType<PlayerAttributePredicate.Arguments>(
    ...
    override fun test(arguments: Arguments): Boolean {
        ...
        val registry = player.level().registryAccess().lookup(Registries.ATTRIBUTE).getOrNull()
            ?: return false
        ...
        val entityAttributeValue = if (entityAttributeEntry != null && player.attributes.hasAttribute(entityAttributeEntry))
