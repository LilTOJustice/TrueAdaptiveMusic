...
class MusicTreeNode private constructor(
    ...
    fun getPathSegment(): String {
        return predicates.joinToString(", ") { it.getTriggerId() }
    }
            ...
            override val descriptions: Map<String, String>
                get() = super.descriptions + mapOf(
                    ...
                    Parameters::loopStartPoints.name to "Some looping music has an intro before the loop starts." +
                            ...
                            "intro.",
                    Parameters::title.name to "Optional name to represent this node. Will show when hovering " +
                            "over the settings button for a node, as well as in the debug hud.",
                )
