...
In TAM 2.0+ you should see a "Get More Packs" button on this screen. You can click it to download community made packs!

Otherwise, throw your .zip or directory file into this folder, then hit "Refresh", and voila! You'll see it show up on this page.
